...
exports.getTimezonesForCountry = exports.getFormattedTimezones = exports.getTimezoneCode = exports.COUNTRY_TIMEZONE_MAP = void 0;
exports.COUNTRY_TIMEZONE_MAP = {
    "Afghanistan": [
        {
            "value": "Asia/Kabul",
            "label": "Asia/Kabul (GMT+4:30)"
        }
    ],
    "Albania": [
        {
    ...
    "Argentina": [
        ...
        },
        {
            ...
            "label": "America/Argentina/La_Rioja (GMT-3)"
        },
        {
            "value": "America/Argentina/San_Juan",
            "label": "America/Argentina/San_Juan (GMT-3)"
        },
        {
        ...
        },
        {
            ...
            "label": "America/Argentina/San_Luis (GMT-3)"
        },
        {
    ...
    "Australia": [
        ...
        },
        {
            ...
            "label": "Australia/Darwin (GMT+9:30)"
        },
        {
    ...
    "Brazil": [
        ...
        },
        {
            ...
            "label": "America/Campo_Grande (GMT-4)"
        },
        {
        ...
        },
        {
            ...
            "label": "America/Porto_Velho (GMT-4)"
        },
        {
            "value": "America/Boa_Vista",
            "label": "America/Boa_Vista (GMT-4)"
        },
        {
        ...
        },
        {
            ...
            "label": "America/Rio_Branco (GMT-5)"
        }
    ],
    "Brunei": [
        {
    ...
    "Cabo Verde": [
        {
            ...
            "label": "Atlantic/Cape_Verde (GMT-1)"
        }
    ],
    "Cambodia": [
        {
            "value": "Asia/Phnom_Penh",
            "label": "Asia/Phnom_Penh (GMT+7)"
        }
    ],
    "Cameroon": [
        {
    ...
    "Ethiopia": [
        {
            ...
            "label": "Africa/Addis_Ababa (GMT+3)"
        }
    ],
    "Fiji": [
        {
    ...
    "Kazakhstan": [
        {
            "value": "Asia/Almaty",
            "label": "Asia/Almaty (GMT+5)"
        },
        {
            "value": "Asia/Qyzylorda",
            "label": "Asia/Qyzylorda (GMT+5)"
        },
        {
            "value": "Asia/Aqtobe",
    ...
    "Mongolia": [
        {
            ...
            "label": "Asia/Ulaanbaatar (GMT+8)"
        },
        {
            "value": "Asia/Hovd",
            "label": "Asia/Hovd (GMT+7)"
        },
        {
            "value": "Asia/Choibalsan",
            "label": "Asia/Choibalsan (GMT+8)"
        }
    ],
    "Montenegro": [
        {
    ...
    "Myanmar": [
        {
            "value": "Asia/Yangon",
            "label": "Asia/Yangon (GMT+6:30)"
        }
    ],
    "Namibia": [
        {
            "value": "Africa/Windhoek",
            "label": "Africa/Windhoek (GMT+2)"
        }
    ],
    "Nauru": [
        {
    ...
    "Papua New Guinea": [
        {
            ...
            "label": "Pacific/Port_Moresby (GMT+10)"
        },
        {
    ...
    "Sri Lanka": [
        {
            "value": "Asia/Colombo",
            "label": "Asia/Colombo (GMT+5:30)"
        }
    ],
    "Sudan": [
        {
            "value": "Africa/Khartoum",
            "label": "Africa/Khartoum (GMT+2)"
        }
    ],
    "Suriname": [
        {
    ...
    "Tanzania": [
        {
            ...
            "label": "Africa/Dar_es_Salaam (GMT+3)"
        }
    ],
    "Thailand": [
        {
...
const getFormattedTimezones = () => {
    ...
    const uniqueTzs = Array.from(new Set(timezones)).sort();
    const date = new Date();
    return uniqueTzs.map(tz => {
        const code = (0, exports.getTimezoneCode)(date, tz);
        return {
            value: tz,
            label: `${tz} (${code})`
        };
...
exports.getFormattedTimezones = getFormattedTimezones;
const getTimezonesForCountry = (countryName) => {
    if (!countryName)
        return (0, exports.getFormattedTimezones)();
    return exports.COUNTRY_TIMEZONE_MAP[countryName] || (0, exports.getFormattedTimezones)();
};
